...
ylabel('Q Value'); 
legend('\gamma = 0.9', '\gamma = 0.99', '\gamma = 0.999')
title('Q Learning (39,1) State Q Value Over Update Number');
grid on;

% saveas(gcf, fullfile(folder_path, 'q_learning_gamma_qvalue_update_analysis.jpg'));
