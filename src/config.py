...
DEFAULT_OVERFLOW_PENALTY_CONSTANT = -1e25  # Penalty per weight unit above safe max
DEFAULT_UNDERFLOW_PENALTY_CONSTANT = -1e25  # Penalty per weight unit below safe min
